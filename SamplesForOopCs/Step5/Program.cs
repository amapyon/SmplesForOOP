    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            while (line != null)
            {
                ...
                {
                    // 契約者情報
                    values.SetOwnerTelNumber(line.Substring(RI_OF_OWNER_TEL_NUMBER));
                }
        ...
        private static void Separator(StreamWriter writer, Values values)
        {
            ...
            if (values.IsFamilyServiceJoined())
            {
                basicCharge += FAMILY_SERVICE_BASIC_CHARGE;
            }

            // 集計結果の出力
            writer.WriteLine("1 " + values.GetOwnerTelNumber());
            writer.WriteLine("5 " + basicCharge);
            writer.WriteLine("7 " + values.GetCallCharge());
            writer.WriteLine("9 ====================");
