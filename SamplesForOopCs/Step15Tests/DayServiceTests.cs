...
namespace Step15.Tests
{
    ...
    public class DayServiceTests
    {
        ...
        public void CalcUnitPriceTest()
        {
            ...
            dayService.CheckService(new Record("2 E1"));
            int unitPrice = (int)dayService.CalcUnitPrice(new Record("5 2004/06/05 18:00 010 090-1234-0002"), 20);
            Assert.AreEqual(20, unitPrice);
            unitPrice = (int)dayService.CalcUnitPrice(new Record("5 2004/06/05 17:59 010 090-1234-0002"), 20);
