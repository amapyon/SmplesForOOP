...
namespace Step8.Tests
{
    ...
    public class FamilyServiceTests
    {
        ...
        public void CalcUnitPriceTest()
        {
            ...
            familyService.CheckService("2 C1 090-1234-0001");
            int unitPrice = familyService.CalcUnitPrice("5 2004/06/05 17:50 010 090-1234-0002", 20);
            Assert.AreEqual(20, unitPrice);
            unitPrice = familyService.CalcUnitPrice("5 2004/06/05 17:50 010 090-1234-0001", 20);
